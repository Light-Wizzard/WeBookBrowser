...
namespace adblock
{
    ...
    /**
     * @class AdBlockLog
     * @brief This class stores information about any recent network requests that were affected by an \ref AdBlockFilter.
     * @ingroup AdBlock
     */
    class AdBlockLog : public QObject
    {
        ...
        public:
            ...
            // Returns all log entries associated with the given first party request url, or an empty container if no entries are found
